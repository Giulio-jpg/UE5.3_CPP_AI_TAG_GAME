...
// End Cross Module References
...
#endif
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ABall_Statics::NewProp_Mesh_MetaData[] = {
		{ "Category", "Ball" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Ball.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ABall_Statics::NewProp_Mesh = { "Mesh", nullptr, (EPropertyFlags)0x00100000000a001d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ABall, Mesh), Z_Construct_UClass_UStaticMeshComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ABall_Statics::NewProp_Mesh_MetaData), Z_Construct_UClass_ABall_Statics::NewProp_Mesh_MetaData) };
	...
	ABall::~ABall() {}
	struct Z_CompiledInDeferFile_FID_Users_giuli_OneDrive_Documenti_GitHub_UE5_3_CPP_AI_TAG_GAME_TagGame_Source_TagGame_Ball_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_giuli_OneDrive_Documenti_GitHub_UE5_3_CPP_AI_TAG_GAME_TagGame_Source_TagGame_Ball_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ABall, ABall::StaticClass, TEXT("ABall"), &Z_Registration_Info_UClass_ABall, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ABall), 2076687167U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_giuli_OneDrive_Documenti_GitHub_UE5_3_CPP_AI_TAG_GAME_TagGame_Source_TagGame_Ball_h_3411769459(TEXT("/Script/TagGame"),
		Z_CompiledInDeferFile_FID_Users_giuli_OneDrive_Documenti_GitHub_UE5_3_CPP_AI_TAG_GAME_TagGame_Source_TagGame_Ball_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_giuli_OneDrive_Documenti_GitHub_UE5_3_CPP_AI_TAG_GAME_TagGame_Source_TagGame_Ball_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
